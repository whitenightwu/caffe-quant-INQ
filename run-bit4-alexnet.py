...
#blob.cpp::{0.8,}
#alexnet-bit4{0.2;0.4;0.6;0.7;0.8;1}
...
os.system("sed -i \"s/(count_\*0.8)/(count_\*0.6)/g\" ./src/caffe/blob.cpp")
os.system("make all -j128")

os.system("sed -i \"s/original.caffemodel/alexnet_part1_iter_39000.caffemodel/g\" ./examples/INQ/alexnet/train_alexnet.sh")
...
os.system("sed -i \"s/(count_\*0.6)/(count_\*0.4)/g\" ./src/caffe/blob.cpp")
os.system("make all -j128")

os.system("sed -i \"s/alexnet_part1_iter_39000.caffemodel/alexnet_part2_iter_39000.caffemodel/g\" ./examples/INQ/alexnet/train_alexnet.sh")
...
os.system("sed -i \"s/alexnet_part2_iter_39000.caffemodel/alexnet_part3_iter_39000.caffemodel/g\" ./examples/INQ/alexnet/train_alexnet.sh")
...
os.system("sed -i \"s/alexnet_part3_iter_39000.caffemodel/alexnet_part4_iter_39000.caffemodel/g\" ./examples/INQ/alexnet/train_alexnet.sh")
os.system("sed -i \"s/part4/part5/g\" ./examples/INQ/alexnet/solver.prototxt")
os.system("nohup sh ./examples/INQ/alexnet/train_alexnet.sh >run5_log.out 2>&1")
...
os.system("make all -j128")
os.system("sed -i \"s/alexnet_part4_iter_39000.caffemodel/alexnet_part5_iter_39000.caffemodel/g\" ./examples/INQ/alexnet/train_alexnet.sh")
...
os.system("sed -i \"s/max_iter: 39000/max_iter: 1/g\" ./examples/INQ/alexnet/solver.prototxt")
os.system("nohup sh ./examples/INQ/alexnet/train_alexnet.sh >run6_log.out 2>&1")
...
os.system("make all -j128")
os.system("sed -i \"s/alexnet_part5_iter_39000.caffemodel/original.caffemodel/g\" ./examples/INQ/alexnet/train_alexnet.sh")
...
os.system("sed -i \"s/max_iter: 1/max_iter: 39000/g\" ./examples/INQ/alexnet/solver.prototxt")
