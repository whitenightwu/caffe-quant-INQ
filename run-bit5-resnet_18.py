...
os.system("sed -i \"s/original_ResNet18.caffemodel/resnet18_part1_iter_200000.caffemodel/g\" ./examples/INQ/resnet-18/train_resnet18.sh")
...
os.system("sed -i \"s/resnet_part1_iter_200000.caffemodel/resnet_part2_iter_200000.caffemodel/g\" ./examples/INQ/resnet-18/train_resnet18.sh")
...
os.system("sed -i \"s/resnet_part2_iter_200000.caffemodel/resnet_part3_iter_200000.caffemodel/g\" ./examples/INQ/resnet-18/train_resnet18.sh")
...
os.system("sed -i \"s/(count_\*0.)/(count_\*0.5)/g\" ./src/caffe/blob.cpp")
os.system("make all -j128")

os.system("sed -i \"s/resnet18_part3_iter_200000.caffemodel/original_ResNet18.caffemodel/g\" ./examples/INQ/resnet-18/train_resnet18.sh")
